...
while cap.isOpened():
    ...
    # ביצוע פעולה
    if final_cmd == "SPINNING": robot.action("spin")
    elif final_cmd == "FOLLOW": robot.action("walk_forward")
    elif final_cmd in ["LIE DOWN", "ATTENTION", "DANCE"]: robot.action(final_cmd.lower())
